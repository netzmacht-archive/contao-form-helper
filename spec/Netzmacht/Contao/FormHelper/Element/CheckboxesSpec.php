 ...
 * @mixin Checkboxes
 */
class CheckboxesSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('Netzmacht\Contao\FormHelper\Element\Checkboxes');
    }
    ...
    function it_has_a_label(Label $label)
    {
        $this->setLabel($label)->shouldReturn($this);
